...
from zenkipay-api-client import rest
from zenkipay-api-client.configuration import Configuration
from zenkipay-api-client.exceptions import ApiTypeError, ApiValueError
from zenkipay-api-client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'Zenkipay-API-Client/python/1.0.0/EN'
