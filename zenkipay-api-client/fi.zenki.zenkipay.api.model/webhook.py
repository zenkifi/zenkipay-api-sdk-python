...
class Webhook(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class eventType(
                ...
                class MetaOapg:
                    max_length = 128
            flatData = schemas.StrSchema
            __annotations__ = {
                "eventType": eventType,
                "flatData": flatData,
            }
    
    flatData: MetaOapg.properties.flatData
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["flatData"]) -> MetaOapg.properties.flatData: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eventType", "flatData", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flatData"]) -> MetaOapg.properties.flatData: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eventType", "flatData", ], str]):
