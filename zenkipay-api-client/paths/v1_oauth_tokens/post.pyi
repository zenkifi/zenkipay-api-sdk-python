...
# body param
SchemaForRequestBodyApplicationJson = RequestTokenOAuth2


request_body_request_token_o_auth2 = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = TokenOAuth2
...
SchemaFor400ResponseBodyApplicationJson = AuthenticationErrorResponse
...
SchemaFor500ResponseBodyApplicationJson = AuthenticationErrorResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_token_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_request_token_o_auth2.serialize(body, content_type)
