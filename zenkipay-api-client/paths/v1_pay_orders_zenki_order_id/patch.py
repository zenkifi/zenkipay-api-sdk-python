...
# body param
SchemaForRequestBodyApplicationJson = UpdateOrder


request_body_update_order = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_order_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_update_order.serialize(body, content_type)
