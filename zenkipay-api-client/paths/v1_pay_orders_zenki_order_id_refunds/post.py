...
# body param
SchemaForRequestBodyApplicationJson = RequestRefund


request_body_request_refund = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Refund
...
class BaseApi(api_client.Api):
    @typing.overload
    def _register_refund_order_oapg(
        self,
    ...
    def _register_refund_order_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_request_refund.serialize(body, content_type)
...
class RegisterRefundOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def register_refund_order(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def register_refund_order(
        ...
        return self._register_refund_order_oapg(
            body=body,
