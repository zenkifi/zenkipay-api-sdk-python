...
ZenkiRefundIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'zenkiOrderId': typing.Union[ZenkiOrderIdSchema, str, ],
        'zenkiRefundId': typing.Union[ZenkiRefundIdSchema, str, ],
    }
)
...
request_path_zenki_refund_id = api_client.PathParameter(
    name="zenkiRefundId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ZenkiRefundIdSchema,
    required=True,
)
...
class GetRefundOrder(BaseApi):
    ...
    def get_refund_order(
        ...
        return self._get_refund_order_oapg(
