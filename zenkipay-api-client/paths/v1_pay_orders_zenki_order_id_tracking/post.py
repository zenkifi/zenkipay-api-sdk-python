...
# body param
SchemaForRequestBodyApplicationJson = AddTracking


request_body_add_tracking = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Tracking
...
class BaseApi(api_client.Api):
    @typing.overload
    def _register_tracking_orders_oapg(
        self,
    ...
    def _register_tracking_orders_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_tracking.serialize(body, content_type)
...
class RegisterTrackingOrders(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def register_tracking_orders(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def register_tracking_orders(
        ...
        return self._register_tracking_orders_oapg(
            body=body,
