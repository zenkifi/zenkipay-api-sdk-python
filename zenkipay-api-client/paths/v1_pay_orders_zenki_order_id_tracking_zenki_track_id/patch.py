...
# Path params
ZenkiOrderIdSchema = schemas.StrSchema
ZenkiTrackIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'zenkiOrderId': typing.Union[ZenkiOrderIdSchema, str, ],
        'zenkiTrackId': typing.Union[ZenkiTrackIdSchema, str, ],
    }
)
...
request_path_zenki_order_id = api_client.PathParameter(
    name="zenkiOrderId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ZenkiOrderIdSchema,
    required=True,
)
request_path_zenki_track_id = api_client.PathParameter(
    name="zenkiTrackId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ZenkiTrackIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = AddTrackingEvent


request_body_add_tracking_event = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TrackingEvents
...
class BaseApi(api_client.Api):
    ...
    def _add_event_tracking_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_zenki_order_id,
            request_path_zenki_track_id,
        ):
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_tracking_event.serialize(body, content_type)
...
class AddEventTracking(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_event_tracking(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def add_event_tracking(
        ...
        return self._add_event_tracking_oapg(
            body=body,
